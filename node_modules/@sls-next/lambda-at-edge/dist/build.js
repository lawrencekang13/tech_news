...
class Builder {
    ...
    async readPagesManifest() {
        const path = (0, path_1.join)(this.serverlessDir, "pages-manifest.json");
    ...
    copyLambdaHandlerDependencies(fileList, reasons, handlerDirectory, base) {
        return fileList
            ...
            const dst = (0, normalizeNodeModules_1.default)(path_2.default.relative(this.serverlessDir, resolvedFilePath));
    ...
    async buildDefaultLambda(buildManifest, apiBuildManifest, separateApiLambda, useV2Handler) {
        var _a;
        const hasAPIRoutes = await fs_extra_1.default.pathExists((0, path_1.join)(this.serverlessDir, "pages/api"));
        return Promise.all([
            ...
            fs_extra_1.default.copy((0, path_1.join)(this.serverlessDir, "pages"), (0, path_1.join)(this.outputDir, exports.DEFAULT_LAMBDA_CODE_DIR, "pages"), {
                filter: (file) => {
                    ...
                    const isNotExcludedJSFile = hasAPIRoutes ||
                        ...
                        this.isSSRJSFile(buildManifest, (0, pathToPosix_1.default)(path_2.default.relative(path_2.default.join(this.serverlessDir, "pages"), file)));
                    return (isNotApiPage &&
    ...
    async buildApiLambda(apiBuildManifest) {
        ...
        return Promise.all([
            ...
            ((_a = this.buildOptions) === null || _a === void 0 ? void 0 : _a.handler)
                ...
                : Promise.resolve(),
            fs_extra_1.default.copy((0, path_1.join)(this.serverlessDir, "pages/api"), (0, path_1.join)(this.outputDir, exports.API_LAMBDA_CODE_DIR, "pages/api")),
    ...
    async buildRegenerationHandler(buildManifest, useV2Handler) {
        await Promise.all([
            ...
            fs_extra_1.default.copy((0, path_1.join)(this.serverlessDir, "pages"), (0, path_1.join)(this.outputDir, exports.REGENERATION_LAMBDA_CODE_DIR, "pages"), {
                filter: (file) => {
                    const isNotPrerenderedHTMLPage = path_2.default.extname(file) !== ".html";
                    const isNotStaticPropsJSONFile = path_2.default.extname(file) !== ".json";
    ...
    copyChunks(handlerDir) {
        return !this.buildOptions.useServerlessTraceTarget &&
            fs_extra_1.default.existsSync((0, path_1.join)(this.serverlessDir, "chunks"))
            ? fs_extra_1.default.copy((0, path_1.join)(this.serverlessDir, "chunks"), (0, path_1.join)(this.outputDir, handlerDir, "chunks"))
            : Promise.resolve();
    }
    async copyJSFiles(handlerDir) {
        await Promise.all([
            (await fs_extra_1.default.pathExists((0, path_1.join)(this.serverlessDir, "webpack-api-runtime.js")))
                ? fs_extra_1.default.copy((0, path_1.join)(this.serverlessDir, "webpack-api-runtime.js"), (0, path_1.join)(this.outputDir, handlerDir, "webpack-api-runtime.js"))
                : Promise.resolve(),
            (await fs_extra_1.default.pathExists((0, path_1.join)(this.serverlessDir, "webpack-runtime.js")))
                ? fs_extra_1.default.copy((0, path_1.join)(this.serverlessDir, "webpack-runtime.js"), (0, path_1.join)(this.outputDir, handlerDir, "webpack-runtime.js"))
                : Promise.resolve()
        ]);
    }
