...
class CoreBuilder {
    ...
    getDefaultHandlerFileFilter(hasAPIRoutes, pageManifest) {
        return (file) => {
            ...
            const isNotExcludedJSFile = hasAPIRoutes ||
                ...
                this.isSSRJSFile(pageManifest, (0, pathToPosix_1.default)(path_2.default.relative(path_2.default.join(this.serverlessDir, "pages"), file)) // important: make sure to use posix path to generate forward-slash path across both posix/windows
                );
    ...
    async copyChunks(handlerDir) {
        return (await fs_extra_1.default.pathExists((0, path_1.join)(this.serverlessDir, "chunks")))
