...
export declare const renderPageToHtml: (page: {
    renderReqToHTML: (req: IncomingMessage, res: ServerResponse, renderMode?: true | "passthrough" | "export" | undefined) => PromiseLike<{
...
}, req: IncomingMessage, res: ServerResponse, renderMode?: true | "passthrough" | "export" | undefined) => Promise<{
    html: string;
    renderOpts: Record<string, any>;
}>;
